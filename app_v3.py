...
class ScoringAgent:
    ...
    def evaluate(self, student_text, q_text, rubric, max_marks, q_id="LIVE"):
        ...
        # LLM grading (authoritative — no penalties)
        ...
        final_score = max(0, min(llm_score, max_marks))

        return (
            round(final_score, 1),
            "✅ Proportional Concept-Based Grading (No Penalty)\n\n**Feedback:**\n" +
    ...
    def get_llm_judgment(self, student, expected, question, rubric, max_marks):
        ...
        STEP 1:
        From the REFERENCE ANSWER, extract distinct core concepts.
        Each independent idea = 1 concept.
        ...
        score = (matched_concepts / total_concepts) * {max_marks}

        RULES:
        - Do NOT penalize brevity.
        - Do NOT reward extra writing.
        - Ignore wording differences.
        - Partial concept = half credit.
        - Completely wrong answer = near 0.
        ...
        "score": number,
        "feedback": ["short bullet 1", "short bullet 2"]
        }}
        """
